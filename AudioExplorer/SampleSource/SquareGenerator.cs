...
namespace AudioExplorer.SampleSource
{
    ...
    /// </summary>
    public class SquareGenerator : ISampleSource
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the amplitude of the square wave.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the phase of the square wave.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SquareGenerator"/> class.
        /// </summary>
        /// <param name="frequency">Specifies the frequency of the square wave in Hz.</param>
        /// <param name="amplitude">Specifies the amplitude of the square wave. Use a value between 0 and 1.</param>
        /// <param name="phase">Specifies the initial phase. Use a value between 0 and 1.</param>
        public SquareGenerator(double frequency, double amplitude, double phase)
        {
            if (frequency <= 0)
        ...
        /// <summary>
        ///     Reads a sequence of samples from the <see cref="SquareGenerator" />.
        /// </summary>
        /// <param name="buffer">
