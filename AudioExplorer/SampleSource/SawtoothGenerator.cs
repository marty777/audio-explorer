...
namespace AudioExplorer.SampleSource
{
    ...
    /// </summary>
    public class SawtoothGenerator : ISampleSource
    {
        /// <summary>
        /// Gets or sets the frequency of the sawtooth wave.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the amplitude of the sawtooth wave.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the phase of the sawtooth wave.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SawtoothGenerator"/> class.
        /// </summary>
        /// <param name="frequency">Specifies the frequency of the sawtooth wave in Hz.</param>
        /// <param name="amplitude">Specifies the amplitude of the sawtooth wave. Use a value between 0 and 1.</param>
        /// <param name="phase">Specifies the initial phase. Use a value between 0 and 1.</param>
        public SawtoothGenerator(double frequency, double amplitude, double phase)
        {
            if (frequency <= 0)
        ...
        /// <summary>
        ///     Reads a sequence of samples from the <see cref="SawtoothGenerator" />.
        /// </summary>
        /// <param name="buffer">
