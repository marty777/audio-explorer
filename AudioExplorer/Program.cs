...
namespace AudioExplorer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Oscillator freqOsc = new Oscillator(Oscillator.WaveType.SineWave, waveFormat.SampleRate, new ConstantScalar(0.1f), new ConstantScalar(200.0f), new ConstantScalar(0), new ConstantScalar(440.0f));
            Oscillator ampOsc = new Oscillator(Oscillator.WaveType.TriangleWave, waveFormat.SampleRate, new ConstantScalar(4.1f), new ConstantScalar(0.5f), new ConstantScalar(0), new ConstantScalar(0.5f));
